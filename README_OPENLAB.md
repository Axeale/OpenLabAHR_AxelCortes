...
### Policy1: [JointTunerPolicy](/G1-Playground/src/g1_playground/policies/movement_testing_tools.py#L74)
...
Como mencione antes, se puede guardar el estado actual del robot(todos los joints), y se guardan como un nuevo elemento en un json llamado [waypoints.json](/G1-Playground/waypoints.json)
...
### Policy2: [PhaseTestPolicy](/G1-Playground/src/g1_playground/policies/movement_testing_tools.py#L210)
